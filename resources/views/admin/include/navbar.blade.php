<nav
    ...
    <div class="card navbar-nav-right d-flex align-items-center" id="navbar-collapse" style="box-shadow: unset;">
        <!-- Search -->
...
{{--                    <small class="text-muted mb-0">Account Setting</small>--}}
{{--                </div>--}}
{{--                </div>--}}
{{--                <div class="row row-bordered overflow-visible g-0">--}}
{{--                <div class="dropdown-shortcuts-item col">--}}
...
{{--                        <img loading="lazy" src="{{asset('assets/img/avatars/1.png')}}" alt class="w-px-40 h-auto rounded-circle" />--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                    <div class="flex-shrink-0">--}}
{{--                        <div class="avatar me-1">--}}
{{--                        <img loading="lazy" src="{{asset('assets/img/avatars/2.png')}}" alt class="w-px-40 h-auto rounded-circle" />--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="d-flex flex-column flex-grow-1 overflow-hidden w-px-200">--}}
...
{{--                    <div class="flex-shrink-0">--}}
{{--                        <div class="avatar me-1">--}}
{{--                        <img loading="lazy" src="{{asset('assets/img/avatars/9.png')}}" alt class="w-px-40 h-auto rounded-circle" />--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="d-flex flex-column flex-grow-1 overflow-hidden w-px-200">--}}
...
{{--                    <div class="flex-shrink-0">--}}
{{--                        <div class="avatar me-1">--}}
{{--                        <img loading="lazy" src="{{asset('assets/img/avatars/5.png')}}" alt class="w-px-40 h-auto rounded-circle" />--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="d-flex flex-column flex-grow-1 overflow-hidden w-px-200">--}}
...
{{--                    <div class="flex-shrink-0">--}}
{{--                        <div class="avatar me-1">--}}
{{--                        <img loading="lazy" src="{{asset('assets/img/avatars/6.png')}}" alt class="w-px-40 h-auto rounded-circle" />--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <div class="d-flex flex-column flex-grow-1 overflow-hidden w-px-200">--}}
...
{{--        </li>--}}
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <div class="avatar avatar-online">
                <img loading="lazy" src="{{asset('assets/img/avatars/male/admin_profile.png')}}" alt class="w-px-40 h-auto rounded-circle" />
            </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
            <li>
            ...
            <li>
                ...
                <i class="mdi mdi-key-change me-2"></i>
