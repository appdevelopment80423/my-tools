...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" id="user-form" action="{{ route('admin.users.store') }}" method="post">
            @csrf
            <hr class="my-4 mx-n4" />
            <div class="row g-4">
                <div class="col-md-6">
                ...
                <div class="input-group input-group-merge">
                    <div class="form-floating form-floating-outline">
                        <input type="email" id="email" name="email" class="form-control" placeholder="Enter email address" autocomplete="off"/>
