...
@section('title', 'User View Team List')
@section('content')
    <!-- Content -->
...
{{--                                </li>--}}
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <ul class="nav nav-tabs mb-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="team-segment"
                ...
                <!-- View Team table -->
                <div class="card mb-4">
                    <h5 class="card-header"> View Team List</h5>
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-2">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center sortable cursor-pointer" data-sort="name">
                                            User Name<span class="sort-indicator"></span></th>
                                        <th class="text-center sortable cursor-pointer" data-sort="email">User Email<span
                                                class="sort-indicator"></span></th>
                                        <th class="text-center sortable cursor-pointer" data-sort="mobile">Mobile No<span
                                                class="sort-indicator"></span></th>
                                        <th class="text-center sortable cursor-pointer" data-sort="pin">Pin<span
                                                class="sort-indicator"></span></th>
                                        <th class="text-center sortable cursor-pointer" data-sort="matching_referrals_count">Referral Count<span
                                                class="sort-indicator"></span></th>
                                    </tr>
                                </thead>
                                <tbody id="data-table">
                                <tr>
                                    <td colspan="6" class="text-center table-loader">Loading...</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    @push('script')
        <script>
            ...
            let totalPages = 1;
            let page_length = 10;
            let column = 'users_details.updated_at';
            let sortOrder = 'desc';
            ...
            function fetchData(page, page_length, column, sortOrder) {
                $.ajax({
                    url: '{{ url('admin/user-view-team/get-list') }}',
                    method: 'GET',
                    data: {
                        page: page,
                    ...
                    success: function(response) {
                        ...
                        if (data === null || data.length === 0 ) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                html += '<td class="text-center">' + data[i].mobile + '</td>';

                                html += '<td class="text-center">' + data[i].pin + '</td>';

                                html += '<td class="text-center">' + data[i].matching_referrals_count + '</td>';
